...
[Home](./index.md) &gt; [@sim/lib-ethers](./lib-ethers.md) &gt; [SendableEthersLiquity](./lib-ethers.sendableethersliquity.md)
...
|  [approveWstEthTokens(allowance, overrides)](./lib-ethers.sendableethersliquity.approvewstethtokens.md) |  | Allow the liquidity mining contract to use Uniswap ETH/LUSD LP tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
