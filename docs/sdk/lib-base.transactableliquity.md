...
[Home](./index.md) &gt; [@sim/lib-base](./lib-base.md) &gt; [TransactableLiquity](./lib-base.transactableliquity.md)
...
|  [approveWstEthTokens(allowance)](./lib-base.transactableliquity.approvewstethtokens.md) | Allow the liquidity mining contract to use Uniswap ETH/LUSD LP tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
