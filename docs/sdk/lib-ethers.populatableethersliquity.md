...
[Home](./index.md) &gt; [@sim/lib-ethers](./lib-ethers.md) &gt; [PopulatableEthersLiquity](./lib-ethers.populatableethersliquity.md)
...
|  [approveWstEthTokens(allowance, overrides)](./lib-ethers.populatableethersliquity.approvewstethtokens.md) |  | Allow the liquidity mining contract to use Uniswap ETH/LUSD LP tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
