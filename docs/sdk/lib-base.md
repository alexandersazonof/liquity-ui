...
[Home](./index.md) &gt; [@sim/lib-base](./lib-base.md)
...
|  [SIM\_LIQUIDATION\_RESERVE](./lib-base.sim_liquidation_reserve.md) | Amount of LUSD that's reserved for compensating the liquidator of a Trove. |
|  [SIM\_MINIMUM\_DEBT](./lib-base.sim_minimum_debt.md) | A Trove must always have at least this much debt. |
|  [SIM\_MINIMUM\_NET\_DEBT](./lib-base.sim_minimum_net_debt.md) | A Trove must always have at least this much debt on top of the [liquidation reserve](./lib-base.sim_liquidation_reserve.md)<!-- -->. |
