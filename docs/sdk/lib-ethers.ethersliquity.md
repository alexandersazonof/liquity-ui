...
[Home](./index.md) &gt; [@sim/lib-ethers](./lib-ethers.md) &gt; [EthersLiquity](./lib-ethers.ethersliquity.md)
...
|  [approveWstEthTokens(allowance, overrides)](./lib-ethers.ethersliquity.approvewstethtokens.md) |  | Allow the liquidity mining contract to use Uniswap ETH/LUSD LP tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
...
|  [getWstEthAllowance(address, overrides)](./lib-ethers.ethersliquity.getwstethallowance.md) |  |  |
|  [getWstEthBalance(address, overrides)](./lib-ethers.ethersliquity.getwstethbalance.md) |  |  |
...
|  [hasStore(store)](./lib-ethers.ethersliquity.hasstore_1.md) |  | Check whether this <code>EthersLiquity</code> is an [EthersLiquityWithStore](./lib-ethers.ethersliquitywithstore.md)<!-- -->&lt;[BlockPolledSimStore](./lib-ethers.blockpolledsimstore.md)<!-- -->&gt;<!-- -->. |
