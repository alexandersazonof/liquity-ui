...
[Home](./index.md) &gt; [@sim/lib-base](./lib-base.md) &gt; [PopulatableLiquity](./lib-base.populatableliquity.md)
...
|  [approveWstEthTokens(allowance)](./lib-base.populatableliquity.approvewstethtokens.md) | Allow the liquidity mining contract to use Uniswap ETH/LUSD LP tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
