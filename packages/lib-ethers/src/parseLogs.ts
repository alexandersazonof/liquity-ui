...
import { _SimContracts, _TypedSimContract } from "./contracts";

type ContractLookup = {
  [name: string]: _TypedSimContract;
};
...
export const logsToString = (receipt: TransactionReceipt, contracts: _SimContracts): string => {
