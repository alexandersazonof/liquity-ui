...
const defaultConfig: SimFrontendConfig = {
...
const parseConfig = (json: unknown): SimFrontendConfig => {
...
let configPromise: Promise<SimFrontendConfig> | undefined = undefined;
...
export const getConfig = (): Promise<SimFrontendConfig> => {
  if (!configPromise) {
