...
import { SimStoreState, StabilityDeposit } from "@sim/lib-base";
...
const select = ({ stabilityDeposit }: SimStoreState): StabilityDeposit => stabilityDeposit;

export const StabilityViewProvider: React.FC = props => {
  const { children } = props;
  const stabilityDeposit = useSimSelector(select);
