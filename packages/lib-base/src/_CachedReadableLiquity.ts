...
export class _CachedReadableLiquity<T extends unknown[]>
  ...
  async getSIMInStabilityPool(...extraParams: T): Promise<Decimal> {
    return (
      this._cache.getSIMInStabilityPool(...extraParams) ??
      this._readable.getSIMInStabilityPool(...extraParams)
    );
  }
  ...
  async getWstEthBalance(address?: string, ...extraParams: T): Promise<Decimal> {
    return (
      this._cache.getWstEthBalance(address, ...extraParams) ??
      this._readable.getWstEthBalance(address, ...extraParams)
    );
  }

  async getWstEthAllowance(address?: string, ...extraParams: T): Promise<Decimal> {
    return (
      this._cache.getWstEthAllowance(address, ...extraParams) ??
      this._readable.getWstEthAllowance(address, ...extraParams)
    );
  }
  ...
  async getTotalStakedSHADY(...extraParams: T): Promise<Decimal> {
    return (
      this._cache.getTotalStakedSHADY(...extraParams) ??
      this._readable.getTotalStakedSHADY(...extraParams)
    );
  }
