...
export interface ReadableLiquity {
   ...
   *
   * @remarks
   * Needed when dealing with instances of {@link @sim/lib-base#TroveWithPendingRedistribution}.
   */
   ...
   * {@link @sim/lib-base#ReadableLiquity.getTrove | getTrove()}.
   */
   ...
   * {@link @sim/lib-base#TransactableLiquity.claimCollateralSurplus | claimCollateralSurplus()}.
   */
