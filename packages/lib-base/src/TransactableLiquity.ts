 ...
 *
 * Implemented by {@link @sim/lib-ethers#EthersLiquity}.
 *
 * @public
 */
export interface TransactableLiquity {
   ...
   *                           {@link @sim/lib-base#Fees.borrowingRate | borrowing rate}.
   *
   * @throws
   ...
   * @param maxBorrowingRate - Maximum acceptable
   *                           {@link @sim/lib-base#Fees.borrowingRate | borrowing rate} if
   ...
   * {@link @sim/lib-base#LUSD_MINIMUM_DEBT}.
   *
   * If `maxBorrowingRate` is omitted, the current borrowing rate plus 0.5% is used as maximum
   * acceptable rate.
   */
   ...
   * {@link @sim/lib-base#StabilityDeposit.collateralGain | collateral gain} and
   * {@link @sim/lib-base#StabilityDeposit.lqtyReward | LQTY reward}.
   */
  ...
  /**
   * Withdraw {@link @sim/lib-base#StabilityDeposit.collateralGain | collateral gain} and
   * {@link @sim/lib-base#StabilityDeposit.lqtyReward | LQTY reward} from Stability Deposit.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
  ...
  /**
   * Transfer {@link @sim/lib-base#StabilityDeposit.collateralGain | collateral gain} from
   ...
   *                            {@link @sim/lib-base#Fees.redemptionRate | redemption rate}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   *
   * @remarks
   * Use {@link @sim/lib-base#ReadableLiquity.getCollateralSurplusBalance | getCollateralSurplusBalance()}
   ...
   * {@link @sim/lib-base#LQTYStake.collateralGain | collateral gain} and
   * {@link @sim/lib-base#LQTYStake.lusdGain | LUSD gain}.
   */
  ...
  /**
   * Withdraw {@link @sim/lib-base#LQTYStake.collateralGain | collateral gain} and
   * {@link @sim/lib-base#LQTYStake.lusdGain | LUSD gain} from LQTY stake.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
   ...
   * {@link @sim/lib-base#TransactableLiquity.stakeUniTokens | staking}.
   *
   ...
   * {@link @sim/lib-base#TransactableLiquity.stakeUniTokens | stakeUniTokens()}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
